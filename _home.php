	...
	<div class="banner">
		<div class="container">
			<div class="banner-left">
				<img src="<?php echo "http://$host"; ?>/public/images/elefante_t.png" alt=" " class="img-responsive" />
			</div>
			...
			<div class="banner-pos">
				<ul id="flexiselDemo1">			
					...
					<script type="text/javascript" src="<?php echo "http://$host"; ?>/public/js/jquery.flexisel.js"></script>
			</div>
		</div>
	</div>
<!-- banner -->
	...
	<div class="testimonials">
		<div class="container">
			<div class="testimonials-grids">
				<center>
				<p style="color: #444;">Hospedado por:</p><br>
